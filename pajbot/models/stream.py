...
class StreamManager:
    ...
    CHANNEL_INFORMATION_CHECK_INTERVAL = 120  # seconds
    STATUS_CHECK_INTERVAL = 20  # seconds
    VIDEO_URL_CHECK_INTERVAL = 2 * 5  # seconds
    ...
    def __init__(self, bot):
        ...
        self.bot.execute_every(
            ...
            self.refresh_channel_information_stage1,
        )
    ...
    def refresh_channel_information_stage1(self):
    ...
    def refresh_stream_status_stage1(self):
        status: UserStream = self.bot.twitch_helix_api.get_user_stream_by_id(self.bot.streamer_user_id)
    ...
    def refresh_stream_status_stage2(self, status: UserStream):
        ...
        # TODO: Resolve game_id to game_name and add to stream_data
        stream_data = {
        ...
        # TODO: Resolve game_id to game_name and update self.game here
        # self.game = status.resolved_game_name_xd
    ...
    def refresh_video_url_stage2(self, data):
        ...
        video = self.fetch_video_url_stage2(data)
